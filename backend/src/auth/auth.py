...
AUTH0_DOMAIN = 'horizonsswsolution.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'drinks'
...
'''
@TO-done-DO implement get_token_auth_header() method
...
'''
@TO-done-DO implement check_permissions(permission, payload) method
    @INPUTS
...
'''
@TO-done-DO implement verify_decode_jwt(token) method
    @INPUTS
